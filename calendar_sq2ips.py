...
#print("wschod:")
#print(ephem.localtime(Gdynia.next_rising(sun)).hour)
#print(ephem.localtime(Gdynia.next_rising(sun)).minute)
#print("Zachod")
#print(ephem.localtime(Gdynia.next_setting(sun)).hour)
#print(ephem.localtime(Gdynia.next_setting(sun)).minute)
