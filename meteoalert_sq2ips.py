...
class MeteoAlertSq2ips(SR0WXModule):
    def __init__(self, language, city_id, start_message, hydronames, short_validity, service_url):
        ...
        self.codes = {"SW": "silnym_wiatrem", "ID": "intensywnymi_opadami_deszczu", "OS": "opadami_s_niegu", "IS": "intensywnymi_opadami_s_niegu", "OM": "opadami_marzna_cymi", "ZZ": "zawiejami_lub_zamieciami_s_niez_nymi", "OB": "oblodzeniem", "PR": "przymrozkami", "RO": "roztopami", "UP": "upal_em", "MR": "silnym_mrozem", "MG": "ge_sta__mgl_a_",
                      "MS": "mgl_a_intensywnie_osadzaja_ca__szadz_", "BU": "burzami", "BG": "burzami_z_gradem", "DB": "silnym_deszczem_z_burzami", "GWSW": "gwal_townym_wzrostem_stano_w_wody", "W_PSA": "wezbraniem_z_przekroczeniem_stano_w_alarmowych", "W_PSO": "wezbraniem_z_przekroczeniem_stano_w_ostrzegawczych", "SH": "susza__hydrologiczna_"}
        self.komcodes = {"SW": "silnym_wietrze", "ID": "intensywnych_opadach_deszczu", "OS": "opadach_s_niegu", "IS": "intensywnych_opadach_sniegu", "OM": "opadach_marzna_cych", "ZZ": "zawiejach_lub_zamieciach_s_niez_nych", "OB": "oblodzeniu", "PR": "przymrozkach", "RO": "roztopach", "UP": "upale", "MR": "silnym_mrozie", "MG": "ge_stej_mgle",
                      "MS": "mgle_intensywnie_osadzaja_cej_szadz_", "BU": "burzach", "BG": "burzach_z_gradem", "DB": "silnym_deszczu_z_burzami", "GWSW": "gwal_townym_wzroscie_stano_w_wody", "W_PSA": "wezbraniu_z_przekroczeniem_stano_w_alarmowych", "W_PSO": "wezbraniu_z_przekroczeniem_stano_w_ostrzegawczych", "SH": "suszy_hydrologicznej"}
